...
void UpdateAudioFilterMenu () {
  al_set_menu_item_flags(menu, OPTIONS_AUDIOFILTER_0_ID, audiofilter == 0 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX);
  al_set_menu_item_flags(menu, OPTIONS_AUDIOFILTER_1_ID, audiofilter == 1 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX);
  al_set_menu_item_flags(menu, OPTIONS_AUDIOFILTER_2_ID, audiofilter == 2 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX);
}
...
void CreateEmulatorMenu() 
{
  ALLEGRO_MENU_INFO menu_info[] = {
    { _(FILE_MENU_ID), 0, 0, NULL },
      ...
      { _(FILE_BOOT_CASSETTE_ID), FILE_BOOT_CASSETTE_ID, 0, NULL },
      ...
      { _(FILE_CROP_SCREENSHOT_ID), FILE_CROP_SCREENSHOT_ID, cropScreenshot ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
    ...
    { _(OPTIONS_MENU_ID), OPTIONS_MENU_ID, 0, NULL },
      ...
      { _(OPTIONS_VOLUME_MENU_ID), OPTIONS_VOLUME_MENU_ID, 0, NULL },
        ...
        ALLEGRO_END_OF_MENU,
      { _(OPTIONS_AUDIOFILTER_MENU_ID), OPTIONS_AUDIOFILTER_MENU_ID, 0, NULL },
        { _(OPTIONS_AUDIOFILTER_0_ID), OPTIONS_AUDIOFILTER_0_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        { _(OPTIONS_AUDIOFILTER_1_ID), OPTIONS_AUDIOFILTER_1_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        { _(OPTIONS_AUDIOFILTER_2_ID), OPTIONS_AUDIOFILTER_2_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        ALLEGRO_END_OF_MENU,
      ALLEGRO_MENU_SEPARATOR,
